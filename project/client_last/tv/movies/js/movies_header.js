function setMoviesHeader(active) {
    document.write(
        ...
        <ul style="margin: 0; position:relative">
            <li class="clickableElement" style="float:left"><a onclick="visitedPagesStack.goToLastVisitedPage()" style="padding-right: 26px;"><em class="fa fa-arrow-left" aria-hidden="true" style="padding-top:9px;"></em></a></li>
            <li class="clickableElement" style="float:left"><a class="to_lobby">3Player</a></li>
            <li style="float: left">
