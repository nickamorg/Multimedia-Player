...
function setMoviesMenu() {
    document.write(
        ...
        `<div id="movies_bottom_menu" class="player text-center">
            ...
            <div class="to_movies_home" style="width:25%; float:left"><button><em style="font-size:40px" class="fa fa-map-signs"></em><p style="font-size:11px">Explore</p></button></div>
            <div class="to_movies_search" style="width:25%; float:left"><button><em style="font-size:40px" class="fa fa-search"></em><p style="font-size:11px">Search</p></button></div>
            <div class="to_mymovies" style="width:25%; float:left"><button><em style="font-size:40px" class="fa fa-film"></em><p style="font-size:11px">My movies</p></button></div>
        </div>`);
}