function setPlayer() {
    ...
    `<div id="bottom_menu" class="player text-center">
        ...
        <div class="col-xs-12" style="background-color:#1D1111">
            ...
            <div class="col-xs-12 scrollbar" style="max-height:400px; padding:0">
                <div id="expand_player" class="collapse">
                    <div class="col-xs-12">
                        <img style="width:100%" src="">
                    </div>
                    <div class="col-xs-5 text-left" style="padding-left:20px">
                        <p>Title</p>
                        <p>Artist</p>
                        <p>Genre</p>
                        <p>Album</p>
                    ...
                    <div class="col-xs-7 text-left" style="padding-right:20px">
                    ...
                    <div class="col-xs-12 scrollbar text-left">
        ...
        <div class="col-xs-12">
            <div class="to_lobby" style="width:20%; float:left"><button><em style="font-size:40px" class="fa fa-home"></em><p style="font-size:11px">3Player</p></button></div>
            <div class="to_song_home" style="width:20%; float:left"><button><em style="font-size:40px" class="fa fa-map-signs"></em><p style="font-size:11px">Explore</p></button></div>
            <div class="to_songs_search" style="width:20%; float:left"><button><em style="font-size:40px" class="fa fa-search"></em><p style="font-size:11px">Search</p></button></div>
            <div class="to_mysongs" style="width:20%; float:left"><button><em style="font-size:40px" class="fa fa-music"></em><p style="font-size:11px">My songs</p></button></div>
            <div class="playlists" style="width:20%; float:left"><button><em style="font-size:40px" class="fa fa-list"></em><p style="font-size:11px">playlists</p></button></div>
        </div>
