...
function setSeriesMenu() {
    document.write(
        ...
        `<div id="series_bottom_menu" class="player text-center">
            ...
            <div class="to_series_home" style="width:25%; float:left"><button><em style="font-size:50px" class="fa fa-map-signs"></em><p style="font-size:24px">Explore</p></button></div>
            <div class="to_series_search" style="width:25%; float:left"><button><em style="font-size:50px" class="fa fa-search"></em><p style="font-size:24px">Search</p></button></div>
            <div class="to_myseries" style="width:25%; float:left"><button><em style="font-size:50px" class="fa fa-tv"></em><p style="font-size:24px">My series</p></button></div>
        </div>`);
}